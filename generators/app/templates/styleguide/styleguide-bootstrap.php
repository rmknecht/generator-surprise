...
<html class="no-js" lang="">
    <head>
        ...
        <title><%= appName %> | Style Guide</title>
    ...
    <body class="styleguide">
        ...
        <div class="container">
            ...
            <!-- Header -->
            <header class="sg-banner row">
                <div class="wrap col-xs-12 col-sm-10 col-sm-offset-2">
                    <h1><%= appName %> - Bootstrap Style Guide</h1>
            ...
            <div class="row">
                <!-- Menu -->
                <aside class="sg-menu col-xs-12 col-sm-2">
                    <h4>Examples</h4>
                    <hr>
                ...
                <!-- Main Content -->
                <main class="sg-main col-xs-12 col-sm-10">
                    <!-- COLORS -->
